...
class Heading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 129,201,149),
        actions: [
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        //FittedBox( fit: BoxFit.none, child: 
        AutoSizeText(aboutUs, maxLines: 6, style: const TextStyle(fontWeight: FontWeight.w500,),),
        )
        //)
        //),
      ]),
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(flex: 3, child: AutoSizeText(joinUsText, maxLines: 7, style: const TextStyle(fontWeight: FontWeight.w500,),)
            ),
